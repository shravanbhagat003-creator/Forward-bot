...
# ⏱️ TIMINGS
DELETE_DELAY = 30   # Message delete after 30 seconds
GAP_DELAY = 30      # Wait 30 seconds between messages

# 🚫 BLOCKED BINS (Jo skip karne hain)
BLOCK_BINS = {
